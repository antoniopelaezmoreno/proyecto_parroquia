...
from .views import crear_sesion, listar_sesiones, pasar_lista,tabla_asistencias_grupo, tabla_asitencias_coord, tabla_asistencias_admin, editar_sesion, eliminar_sesion, mostrar_sesion
...
urlpatterns = [
    ...
    path('<int:sesionId>', mostrar_sesion, name='mostrar_sesion'),

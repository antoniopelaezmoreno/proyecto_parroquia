...
def index(request):
    if request.user.is_authenticated:
        ...
        if request.user.is_coord:
            ...
            return render(request, 'index/index_coord.html', {'grupos': grupos, 'proxima_sesion': proxima_sesion, 'archivos_sesion': archivos_sesion,'notificaciones': notificaciones, 'num_catecumenos': num_catecumenos, 'num_ausencias': num_ausencias, 'num_ausencias_ultima_sesion': num_ausencias_ultima_sesion})
